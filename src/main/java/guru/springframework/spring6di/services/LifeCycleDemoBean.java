...
public class LifeCycleDemoBean implements InitializingBean, DisposableBean, BeanNameAware,
    ...
    @Value("${java.specification.version}") // ovo je takozvani Spring Exprssion Language, @Value(${xxx.yyy.zzz})
    ...
    @PostConstruct //okida se kad se završi proces konstriranja Bean-a, ali prije nego se uspostave zavisne veze i property-ji
